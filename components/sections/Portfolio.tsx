      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_280px] lg:grid-cols-[1fr_320px]">
        ...
        <div className="relative md:border-l border-t md:border-t-0 border-blue-border bg-bg-surface flex flex-col items-center justify-between px-8 py-10 overflow-hidden">
          ...
          <div className="w-full border-t border-blue-border pt-5 text-center">
            <p className="font-sans text-[10px] uppercase tracking-[0.2em] text-text-tertiary mb-1">
              Est.
            </p>
            <p className="font-display text-display-md leading-none opacity-40 text-text-secondary">
              {founded}
            </p>
...
export default function Portfolio() {
  return (
    <section
      id="portfolio"
      className="relative overflow-hidden bg-bg-base py-28 md:py-36"
    >
      {/* Atmospheric blobs */}
      <FloatingBlob
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="flex flex-col gap-6">
          <CompanyCard
            tag="Communication Technology · Since 1993"
          ...
          />
          <CompanyCard
            tag="Web Accessibility · Founded 2025"
