...
const fadeUpVariants = {
  ...
  visible: (i: number) => ({
    opacity: 1,
    y: 0,
    transition: { duration: 0.9, delay: 0.4 + i * 0.18, ease: [0.25, 0.4, 0.25, 1] },
  }),
}
...
function HeroBlob({
  ...
  return (
    <motion.div
      ...
      transition={{
        opacity: { duration: fadeDuration,         delay, repeat: Infinity, ease: "easeInOut", times: [0, 0.04, 0.50, 0.74, 1] },
        ...
        y:       { duration: driftDuration * 0.78, delay: delay + 1.5, repeat: Infinity, ease: "easeInOut" },
      }}
    />
  )
}
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-bg-base">
      ...
      <HeroBlob
        ...
        delay={0} breathDuration={10} fadeDuration={18} driftDuration={22} driftX={65} driftY={55}
      />

      {/* 2 · Top-center, wide pill */}
      <HeroBlob
        className="top-0 left-[18%] w-[520px] h-[280px] bg-gradient-to-r from-sky-400/48 to-blue-600/32 blur-[120px]"
        delay={0.05} breathDuration={13} fadeDuration={22} driftDuration={26} driftX={45} driftY={60}
      />

      {/* 3 · Top-right */}
      <HeroBlob
        className="top-0 right-0 w-[580px] h-[500px] bg-gradient-to-bl from-indigo-500/50 to-blue-600/34 blur-[130px]"
        delay={0.10} breathDuration={9} fadeDuration={16} driftDuration={20} driftX={-72} driftY={58}
      />
      ...
      <HeroBlob
        ...
        delay={0.15} breathDuration={8} fadeDuration={15} driftDuration={18} driftX={68} driftY={-58}
      />
      ...
      <HeroBlob
        ...
        delay={0.20} breathDuration={12} fadeDuration={20} driftDuration={25} driftX={55} driftY={48}
      />

      {/* 6 · Center-right */}
      <HeroBlob
        className="top-[18%] right-[8%] w-[500px] h-[480px] bg-gradient-to-tl from-indigo-400/44 to-sky-500/28 blur-[120px]"
        delay={0.25} breathDuration={7} fadeDuration={14} driftDuration={19} driftX={-58} driftY={50}
      />
      ...
      <HeroBlob
        ...
        delay={0.30} breathDuration={10} fadeDuration={18} driftDuration={21} driftX={68} driftY={-48}
      />
      ...
      <HeroBlob
        ...
        delay={0.35} breathDuration={14} fadeDuration={24} driftDuration={28} driftX={-42} driftY={-52}
      />

      {/* 9 · Bottom-right */}
      <HeroBlob
        className="bottom-0 right-0 w-[540px] h-[440px] bg-gradient-to-tl from-blue-500/48 to-indigo-600/32 blur-[125px]"
        delay={0.40} breathDuration={8} fadeDuration={16} driftDuration={20} driftX={-62} driftY={-42}
      />
      ...
      <HeroBlob
        ...
        delay={0.08} breathDuration={6} fadeDuration={12} driftDuration={15} driftX={38} driftY={35}
      />
      ...
      <div aria-hidden="true" className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-bg-base to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 md:px-10">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.div custom={0} variants={fadeUpVariants} initial="hidden" animate="visible">
            <span className="inline-flex items-center gap-2 px-3 py-1 rounded text-[11px] sm:text-xs tracking-[0.1em] uppercase font-sans font-medium text-text-secondary border border-blue-border bg-blue-subtle mb-8">
              {badge}
            </span>
          </motion.div>
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="font-display text-display-xl leading-[1.0] mb-6 break-words">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r dark:from-blue-DEFAULT dark:via-blue-400 dark:to-sky-400 from-blue-700 via-blue-DEFAULT to-blue-600 italic">{title2}</span>
            </h1>
          </motion.div>
